...
<div class="container-fluid">
    <div class="row">
        <form action="{{ url('categories/create') }}" method="POST" class="col-sm-12">
            <div class="form-group" style="width: 18%;float: left">
                <input type="text" class="form-control" id="newNoteCategory" placeholder="New Note">
            </div>
            <div class="form-group" style="width: 2%;float: left"></div>
            <div class="form-group" style="width: 68%;float: left">
                <input type="text" class="form-control" id="newNote" placeholder="What's your thinking...">
            </div>
            <div class="form-group" style="width: 2%;float: left"></div>
